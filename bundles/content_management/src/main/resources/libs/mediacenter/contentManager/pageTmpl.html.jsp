...
<head>
    ...
    <script type="text/javascript"
            src="<%= request.getContextPath() %>/js/backbone/backbone.validation-0.6.2.js"></script>

    <script type="text/javascript"
            src="<%= request.getContextPath() %>/js/mediacenter/commons-${commons.version}.js"></script>
    <script type="text/javascript"
            src="<%= request.getContextPath() %>/js/mediacenter/content_management-${project.version}.js"></script>
    <script type="text/javascript"
            src="<%= request.getContextPath() %>/js/infinite-list/infinite-list-1.1-SNAPSHOT.js"></script>
...
<sling:include path="<%=resource.getPath().concat(\".dashboardHeader.html\")%>" resourceType="mediacenter/dashboard"
               replaceSuffix="vodManager"></sling:include>
