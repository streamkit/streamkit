 ...
 * under the License.
 */
package org.mediacenter.dashboard;
 ...
 * <p>
 *     Sample usage:
 *     http://localhost:8080/content/channel/demo.widget_query.tidy.json?queryType=xpath
 *                      &statement=//*[sling:resourceType='mediacenter:widget']
 *                      &property=title
 *                      &property=grid_size
 *
 * </p>
 *
 * Use this as the default query servlet to read the list of widgets associated to an account
 */
@Component(immediate=true, metatype = false)
@Service
@Properties({
        @Property(name="service.description", value="Media Center widget Query Servlet"),
        @Property(name="service.vendor", value="Media Center Org"),
        @Property(name="sling.servlet.resourceTypes", value= {"mediacenter:channel"}),
        @Property(name="sling.servlet.selectors", value= "widget_query"),
        @Property(name="sling.servlet.extensions", value= "json"),
        @Property(name="sling.servlet.prefix", value= "-1", propertyPrivate = true )
})
public class WidgetQueryServlet extends SlingSafeMethodsServlet
{

    private static final long serialVersionUID = 1L;

    private final Logger log = LoggerFactory.getLogger(WidgetQueryServlet.class);
    ...
    private void dumpResult(SlingHttpServletRequest req,
        ...
        try {
            ...
            statement = createJcrRoot(req, statement);
    ...
    /**
     * Determines what should be the root note in which to search for widgets.
     * if no jcr:root is specified in the statement, then /jcr:root/content/mediacenter is used.
     * @param req
     * @param statement
     * @return
     */
    private String createJcrRoot(SlingHttpServletRequest req, String statement)
    {
        if ( statement.indexOf("jcr:root") < 0 )
        {
            statement = "/jcr:root/content/mediacenter/widgets" + statement;
        }
        return statement;
    }
